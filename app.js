...
const projectName = "alcohol-rater";
...
const alcoholRoutes = require("./routes/alcohol.routes"); // <== import (require) alcohol routes
app.use("/", alcoholRoutes); // <== use alcohol routes
